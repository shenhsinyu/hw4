...
flags.DEFINE_integer("scale", 3, "Scale factor for Super Resolution (should be 2 or more)")
flags.DEFINE_integer("layers", 7, "Number of layers of feature xxtraction CNNs")
flags.DEFINE_integer("filters", 96, "Number of filters of first feature-extraction CNNs")
...
flags.DEFINE_integer("nin_filters", 72, "Number of CNN filters in A1 at Reconstruction network")
flags.DEFINE_integer("nin_filters2", 48, "Number of CNN filters in B1 and B2 at Reconstruction net.")
...
flags.DEFINE_integer("batch_num", 30, "Number of mini-batch images for training")
flags.DEFINE_integer("batch_image_size", 48, "Image size for mini-batch")
flags.DEFINE_integer("stride_size", 16, "Stride size for mini-batch. If it is 0, use half of batch_image_size")
flags.DEFINE_integer("training_images", 1200, "Number of training on each epoch")
...
flags.DEFINE_float("end_lr", 0.0001, "Training end learning rate. If the current learning rate gets lower than this"
                                   "value, then training will be finished.")

# Dataset or Others
flags.DEFINE_string("dataset", "train", "Training dataset dir. [yang91, general100, bsd200, other]")
flags.DEFINE_string("test_dataset", "test-lr", "Directory for test dataset [set5, set14, bsd100, urban100, all]")
...
flags.DEFINE_string("checkpoint_dir", "models/ckpt", "Directory for checkpoints")
